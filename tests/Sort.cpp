...
GTEST_TEST(SortTest, SortedStringArray) {
...
GTEST_TEST(SortTest, ReverseSortedStringArray) {
    using namespace std::string_literals;
...
GTEST_TEST(SortTest, RandomStringArray) {
    using namespace std::string_literals;
...
GTEST_TEST(SortTest, LargeStringArray) {
    constexpr std::size_t kLargeArraySize = 1'000;
    std::mt19937 engine{0}; // NOLINT(cert-msc51-cpp)
